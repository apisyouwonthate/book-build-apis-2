...
image::/images/guides/efficient-tech-writing-process/bump-tag-description.png[Untitled]
...
image::/images/guides/efficient-tech-writing-process/bump-x-topics.png[Untitled]
