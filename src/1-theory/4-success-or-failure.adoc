...
Two examples from a carpooling application which whad a "simulated savings" endpoint, to let folks know how much they might save picking up a passenger on their daily commute:
