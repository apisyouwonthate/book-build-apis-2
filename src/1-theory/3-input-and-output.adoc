...
NOTE: GET requests can technically have a body, and some servers and tools will start
...
contain a body. This is great for checks to see if something exists (by inspecting the status code), and if it
