...
tricky to confirm they are sending what you think, and they used to be tricky to document.
...
That ngrok mention might have made you notice an issue with web hooks: you need
...
application running in the user's browser then that isn't going to work.
